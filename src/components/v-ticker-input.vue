<template>
  <section>
    ...
    <button
      :disabled="!ticker"
      :class="{
        'opacity-70 cursor-default': !ticker,
        ' hover:bg-gray-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500': !!ticker
      }"
      type="button"
      @click="addTicker"
...
<script>
import { loadCurencyList } from "../api";
export default {
  props: {
    tickers: {
      type: Array,
